...
function [SentenceMarkerOnsets, SentenceMarkerTypes, WordMarkerOnsets, WordMarkerTypes] = getMarkerTypes(EEG, signalInfoPath, WordAlignerPath, subjectStimulusOrder)
...
%         end
        ...
        for sentenceIdx = 1 : 60
            ...
            if sentenceIdx == 1
                ...
                % frequency (EEG.srate)
                SentenceMarkerOnsets(end+1)=SentenceMarkerOnsets(end) + ((0.3 + loadedVariables.signalLength) * EEG.srate);
